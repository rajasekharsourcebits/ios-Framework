...
private let thumbViewWidth: CGFloat = 5
private let thumbViewHeight: CGFloat = 30
...
//        thumbView.layer.cornerRadius = thumbSize/2
    ...
    private func setUpThumbViewConstraints() {
        ...
        thumbView.widthAnchor.constraint(equalToConstant: thumbViewWidth).isActive = true
        thumbView.heightAnchor.constraint(equalToConstant: thumbViewHeight).isActive = true
